export default function Lang() {
    return (
        <div className="p-5 mt-4 flex fixed end-10">
            ...
            <button className="active:scale-95 transition duration-100 ease-in-out ml-5 text-lg bold hover:underline cursor-pointer" style={{color: 'var(--gray)'}}>EN</button>
        </div>
    );
}
