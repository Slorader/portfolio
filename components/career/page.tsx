...
export default function Career() {
    return (
        <>
            ...
            <a href="https://www.ccsd.cnrs.fr/" className="relative flex w-full group transition duration-300 ease-in-out hover:border-[var(--main-color)] rounded-[10px] border-2 border-solid border-[#e1e5ea] p-4 mb-5">
                <div>
                ...
                <div className="flex flex-col mx-8">
                    <h3 className="text-xl font-semibold">Work-study Developer</h3>
                    <p className="text-xs text-[var(--gray)]">CCSD</p>
                    <p className="text-xs text-[var(--gray)]">2024 - Present</p>
                    <p className="text-xs text-[var(--gray)]">Lyon, France</p>
                    <p className="mt-3 text-s text-[var(--gray)]">I&#39;m working on the HALiance project.</p>
                    <FaExternalLinkAlt
            ...
            <a href="https://www.rgu.ac.uk/"
               className="relative flex group transition duration-300 ease-in-out hover:border-[var(--main-color)] rounded-[10px] border-2 border-solid border-[#e1e5ea] p-4 mb-5">
                ...
                <div className="flex flex-col m-w-20 mx-8">
                    <h3 className="text-xl font-semibold">Student Researcher</h3>
                    <p className="text-xs text-[var(--gray)]">Robert Gordon University</p>
                    <p className="text-xs text-[var(--gray)]">April 2024 - July 2024</p>
                    <p className="text-xs text-[var(--gray)]">Aberdeen, Scotland</p>
                    <p className="mt-3 text-s text-[var(--gray)]">I was working on the creation of AI models to automate the argumentative analysis processus.</p>
                    <FaExternalLinkAlt
                        className="group-hover:text-[var(--main-color)] transition duration-300 ease-in-out absolute top-3 right-3 text-30"
                        fontSize={20}/>
                </div>
